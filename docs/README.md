# bEliza Documentation Site

This the official documentation site of beliza. A flexible, scalable and customizable agent for production apps. which Comes with batteries-including database, deployment and examples using Supabase and Cloudflare.
...
You can use SQLite for local development. This is the easiest way to get started with beliza.
    ...
    import { AgentRuntime, SqliteDatabaseAdapter } from "beliza";
...
### Usage
      ...
      import { AgentRuntime, SupabaseDatabaseAdapter, SqliteDatabaseAdapter } from "beliza";
...
it is good to interact with the beliza and read more about the documentation on https://www.beliza.org/docs
