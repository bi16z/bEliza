...
<img src="./docs/static/img/beliza_banner.jpg" alt="bEliza Banner" width="100%" />

-   Multi-agent simulation framework
-   Add as many unique characters as you want with [characterfile](https://github.com/bi16z/characterfile)
...
-   Highly extensible - create your own actions and clients to extend bEliza's capabilities
...
To avoid git clashes in the core directory, we recommend adding custom actions to a `custom_actions` directory and then adding them to the `belizaConfig.yaml` file. See the `belizaConfig.example.yaml` file for an example.
